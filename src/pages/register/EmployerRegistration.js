...
const EmployerRegistration = () => {
  ...
  const { isSuccess, user: { email } } = useSelector((state) => state.auth);
    ...
    <div className='flex justify-center items-center overflow-auto p-10'>
      ...
      >
        ...
        <div className='flex flex-col w-full max-w-xs'>
          ...
          <input className="cursor-not-allowed" type='email' value={email} id='email' contentEditable={false}  {...register("email")} />
        </div>
        <div className='flex flex-col w-full max-w-xs'>
